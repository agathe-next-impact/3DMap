...
export const STOPS: Stop[] = [
  ...
  },
  {
    ...
    description: "La Maison de Blanche-Neige est une habitation isolee nichee au coeur de bois de la Justice du \"bois de l'Hermitage\" avec leur famille, loin de l'agitation du monde.",
  ...
  },
  {
    id: 'guinguette',
    name: 'La Guinguette',
    lat: 49.437497133664785,
    lng: 3.12662404395073,  
    emoji: '\u{1F37A}',
    category: 'Loisir',
