...
export const STOPS: Stop[] = [
  {
    ...
    clueText: "Votre premier indice se trouve devant la grande maison, amusez-vous bien et soyez vigilant, l'Histoire est pleine de rebondissements.Pour trouver vos indices repérez-vous sur la carte et cliquez si vous pensez avoir trouvé le prochain indice. Amusez-vous bien ;-) ",
    clueHint: "Continuez vers le nord-est depuis les ateliers. C'est le plus grand batiment du domaine.",
    description: "La Grande Maison est le batiment principal de l'Hermitage. Cette imposante demeure à colombages de trois etages temoigne de l'architecture néo-normande de la reconstruction des territoires du nord de la France détruits par les combats de la première guerre mondiale . Aujourd’hui lieu de sommeil et de salle à manger pour les groupes. Elle sera votre maison le temps de votre séjour inspirant à l’Hermitage :-) ",
    history: "",
  ...
  },
  {
    ...
    description: "Dans ma bannette et devinette. Présent sur tous les continents, j'ai plus d'un million d'années. ",
  ...
  },
  {
    ...
    clueHint: "Aujourd’hui c’est un café-cantine associatif, lieu de lien, de rencontre et de convivialité.",
    description: "Vous venez de faire un tour d’horizon de l’Hermitage d’hier à aujourd’hui.",
  ...
  },
  {
    ...
    clueText: "Au bout du chemin, cachee sous la canopee, une maison semble tout droit sortie d'un conte.",
    clueHint: "Descendez vers le sud-ouest depuis le plateau.",
    description: "La Maison de Blanche-Neige est une habitation isolee nichee au coeur de bois de la Justice dt \"bois de l'Hermitage\"u avec leur famille, loin de l'agitation du monde.",
    history: "Cette maison etait autrefois un petit atelier d'apiculture, puis ce fut transformé en petit logement pour accueillir de jeunes coopérants internationaux avant leur départ en mission internationale.",
  ...
  },
  {
    ...
    history: "Dans ma bannette : Rapportez une feuille de hêtre.",
  ...
  },
  {
    ...
    clueText: 'C\'était autrefois une ferme, on y trouvait des poulets, puis des chèvres et des lapins.',
    clueHint: 'Très belle vue sur l\'Hermitage.',
    description: 'Ici on fabrique, on fait autrement, on répare on imagine. Le fablab avec ses imprimantes 3D, découpeuse, graveuse laser; sérigraphie. Ici notre seule limite c\'est notre imagination. ',
  ...
  },
  {
    ...
    clueText: "Quel est le rapport entre un fraisier et un poisson ? Trouvez ce système d'agriculture inovante. ",
    clueHint: "",
    description: "L’entreprise d’aquaponie Végéto est présente depuis la reprise de l’Hermitage en 2017.",
  ...
  },
  {
    id: "accident",
    name: "L'Accident",
    lat: 49.43683351060263,
    lng: 3.1274776716670427,
    emoji: '\u{1F4A5}',
    category: 'Histoire',
    categoryIcon: '\u{1F3DE}',
    ...
    description: "Abandonnée en amont de la forêt depuis les années 70, ce véhicule meuble les souvenirs des promeneurs.",
    history: "",
  ...
  },
  {
    ...
    clueText: "Je suis une partie de la mémoire de ce bois, vous foulez en ce moment même un lieu d'histoire.",
    clueHint: "Depuis l'accident, dirigez-vous vers le nord-est.",
    description: "EMPREINTE : Ces stèles blanches érigées vers le ciel, rappellent les cimetières des soldats inconnus.",
  ...
  },
  {
    ...
    description: "Dans ma bannette : On trouve des pommes de pin dans cette zone.",
    history: "Quoi de mieux qu'une photo dans un cadre idyllique ?",
  ...
  },
  {
    ...
    clueText: "Ouvrez l'œil, soyez attentif à votre environnement ! Nous sommes un peu les gardiens de ce lieu.",
    clueHint: "Cherchez ce gardien pour trouver votre prochain indice !",
    description: "Bravo vous m'avez trouvé ! Je suis un vieux Pin corse planté par le premier propriétaire dans les années 1930.",
    history: "",
    svgColors: { sky: '#87CEEB', ground: '#228B22', accent: '#FFD700' }
  },
  {
